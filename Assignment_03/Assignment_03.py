...
class Order:
    ...
    def receipt(self):
        lines = [
            "Receipt for " + self.customer.customer_name + " (" + self.customer.name + ")",
            "-" * 40,
        ]
...
def build_orders():
    ...
    for name, tier, raw_items in ORDERS:
        customer = build_customer(name, tier)
